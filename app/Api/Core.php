...
public  function get_banner(){
    $banner = ChildBanner::query('child_banner')->select('child_banner.parent_id as pr_id'
        ,'child_banner.img_banner_mt','child_banner.img_banner_dt',
        'child_banner.link', 'parent_banner.*')
        ->join('parent_banner', 'parent_banner.id', '=' , 'child_banner.parent_id')
        ->where('parent_banner.status',"===", 0)
        ->get();
    return $banner;
}
