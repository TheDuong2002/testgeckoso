...
use App\Exports\ExcelExportsUserCart;
...
class BEClientController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        $user_categorys =  UserCategory::where('parent_id', '==', 0)->with('children')->get();
        $values = [
            'page_title' => $pageTitle,
             'user_cates' =>  $user_categorys,
             'user' => $user,
        ];
...
//        echo '<pre>';var_dump($values);die;
    ...
    public function exportExcel(){
            ...
            return Excel::download(new ExcelExportsUserCart, 'danhsachkhachhang.xlsx' );
