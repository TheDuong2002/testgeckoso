...
//UserCategory
Route::get('/admin/user/category/list','BEUserCategoryController@index');
Route::post('/admin/user/category/save','BEUserCategoryController@save');
Route::post('/admin/user/category/delete','BEUserCategoryController@delete');
Route::post('/admin/user/category/update','BEUserCategoryController@update');

//UserCategory sub
Route::post('/admin/user/category/add/sub','BEUserCategoryController@add_sub');
Route::post('/admin/user/category/sub/delete','BEUserCategoryController@delete_sub');
Route::post('/admin/user/category/sub/update','BEUserCategoryController@update_sub');

//banner
Route::get('/admin/banners', 'BEBannerController@show_parent_banner');
Route::post('/admin/banners/save', 'BEBannerController@save_parent_banner');
Route::get('/admin/banner/delete/{id}', 'BEBannerController@delete');
Route::get('/admin/banner/detail/{id}', 'BEBannerController@show_banner_detail');


Route::post('/admin/banners/attribute/save/{id}', 'BEBannerController@banner_attr_save');
Route::get('/admin/banners/attribute/delete/{chi_id}', 'BEBannerController@banner_attr_delete');
Route::get('/admin/banners/attribute/update/{chi_id}', 'BEBannerController@banner_attr_update');
Route::post('/admin/banners/attribute/save_update', 'BEBannerController@banner_attr_save_update');

Route::get('/admin/banner/update-satatus/{id}', 'BEBannerController@updateStatus');
...
Route::get('/admin/client/export_csv', 'BEClientController@exportExcel');
//categories
...
Route::get('/admin/order/export-list', 'BEOrderController@exportList');

// Page-footer
Route::get('/admin/page-footer', 'BEPageFooterCotroller@index');
Route::get('/admin/page-footer/add', 'BEPageFooterCotroller@add');
Route::post('/admin/page-footer/save', 'BEPageFooterCotroller@save');
Route::get('/admin/page-footer/delete/{id}', 'BEPageFooterCotroller@delete');
Route::get('/admin/page-footer/update-satatus/{id}', 'BEPageFooterCotroller@updateStatus');
Route::get('/admin/page-footer/edit/{id}', 'BEPageFooterCotroller@edit');
Route::post('/admin/page-footer/saveUpate/{id}', 'BEPageFooterCotroller@saveUpate');
//undone
...
Route::get('/p_footer_infor/{href}', 'FEHomeController@chinhSachChiTIet');
