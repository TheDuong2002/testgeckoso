    ...
    <div id="nt_cart_canvas" class="nt_fk_canvas dn">
        <form action="" method="post" novalidate="" class="nt_mini_cart flex column h__100 btns_cart_1">
            <div class="mini_cart_header flex fl_between al_center">
                <button type="button" class="button button_primary text-uppercase btn-cart" onclick="openPage('<?php echo e(url('/gio-hang')); ?>');">giỏ hàng</button>
...
<div class="push-sale-hihi push-right" id="add-to-cart">
    <div class="row al_center no-gutters fl_nowrap pr bg-success text-white font-italic">
        ...
        Bạn đã thêm <b class="spc ml__5 mr__5"></b> sản phẩm vào <a class="ml__5 text-fff text-bold" href="<?php echo e(url('gio-hang')); ?>">giỏ hàng!</a>
    </div>
</div>
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        <?php if(!empty($dkTC)): ?>
        pushMessage("Chào <?php echo e($dkTC); ?>, cảm ơn bạn đã đăng ký!");
        <?php elseif(!empty($dnTC)): ?>
        pushMessage("Chào <?php echo e($dnTC); ?>, thật vui khi được gặp lại bạn!");
        <?php endif; ?>
    });
</script>
