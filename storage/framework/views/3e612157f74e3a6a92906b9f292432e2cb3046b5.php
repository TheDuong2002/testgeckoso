    ...
    <div class="shopify-section mb_nav_tab menu_1 active">
        <ul id="menu_mb_ul" class="nt_mb_menu">
            <li class="menu-item item-level-0">
                <a class="text-capitalize" href="<?php echo e(url('gioi-thieu')); ?>">về chúng tôi</a>
            </li>



            <li class="menu-item item-level-0">
                <a class="text-capitalize" href="<?php echo e(url('goc-tu-van')); ?>">góc tư vấn</a>
            </li>
            <li class="menu-item item-level-0">
                <a class="text-capitalize" href="<?php echo e(url('tin-tuc')); ?>">tin tức</a>
            </li>
            <li class="menu-item item-level-0">
                <a class="text-capitalize" href="<?php echo e(url('lien-he')); ?>">liên hệ</a>
            </li>
            <?php if(!$viewer): ?>
                <li class="menu-item item-level-0">
