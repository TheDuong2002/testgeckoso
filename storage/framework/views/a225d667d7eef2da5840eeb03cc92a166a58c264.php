    ...
    <div id="shopify-section-cart-template" class="shopify-section cart_page_section container mb__60">
        ...
        <?php if(!count($products)): ?>
            <div class="empty_cart_page tc" style="margin-top: 20px !important;">
                ...
                <p class="mb__15">
                    <?php if($viewer): ?>
                    <a class="button tu mr__5 mb__5" href="<?php echo e(url('/tai-khoan?t=dhdd')); ?>">xem đơn hàng đã đặt</a>
                    <?php endif; ?>
                    <a class="button button_primary tu mr__5 mb__5" href="<?php echo e(url('/san-pham')); ?>">tiếp tục mua hàng</a>
                </p>
            </div>
        <?php else: ?>
