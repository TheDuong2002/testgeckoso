...
<?php $__env->startSection('content'); ?>
    ...
    <div>
        <div class="fade-in">
            <form action="<?php echo e(url('admin/news/save')); ?>" method="post" enctype="multipart/form-data"
    ...
    <script type="text/javascript" src="<?php echo e(url('public/js/back_end/news_add.js')); ?>"></script>
...
<?php echo $__env->make('templates.be.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\geckosotest\resources\views/pages/back_end/news/add.blade.php ENDPATH**/ ?>