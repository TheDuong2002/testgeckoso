...
<?php $__env->startPush('style'); ?>
    <link href="<?php echo e(url('public/libraries/zoom/magiczoomplus.css')); ?>" rel="stylesheet">
    <style data-shopify>
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="row mb__10 pr_sticky_content">
                            ...
                            <div class="example-container">
                                <div class="roland-garros-babolat">
                                    <div class="selectors">
                                        ...
                                        ?>
                                        <a
                                            href="javascript:void(0)" onclick="jsspvideo('<?php echo e($item->video_link); ?>')"
                                            class="mz-thumb">
                                            <img src="http://img.youtube.com/vi/<?php echo e($arr[count($arr)]); ?>/hqdefault.jpg" />
                                        </a>
                                        <?php endif;?>
                                        <a data-zoom-id="rg-babolat"
                                           href="<?php echo e($item->getAvatar()); ?>?scale.width=900"
                                           data-zoom-image-2x="<?php echo e($item->getAvatar()); ?>"
                                           data-image="<?php echo e($item->getAvatar()); ?>?scale.width=350"
                                           data-image-2x="<?php echo e($item->getAvatar()); ?>?scale.width=700"
                                           class="mz-thumb-selected mz-thumb">
                                            <img alt="Magic Zoom Plus - Examples"
                                                 src="<?php echo e($item->getAvatar()); ?>?scale.width=60"
                                                 srcset="<?php echo e($item->getAvatar()); ?>?scale.width=120 2x" />
                                        </a>
                                        <?php if(count($item->getSlides())): ?>
                                            <?php $__currentLoopData = $item->getSlides(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a data-zoom-id="rg-babolat"
                                                   href="<?php echo e($photo->getPhoto()); ?>?scale.width=900"
                                                   data-zoom-image-2x="<?php echo e($photo->getPhoto()); ?>"
                                                   data-image="<?php echo e($photo->getPhoto()); ?>?scale.width=350"
                                                   data-image-2x="<?php echo e($photo->getPhoto()); ?>?scale.width=700"
                                                   class="mz-thumb">
                                                    <img alt="Magic Zoom Plus - Examples"
                                                         src="<?php echo e($photo->getPhoto()); ?>?scale.width=60"
                                                         srcset="<?php echo e($photo->getPhoto()); ?>?scale.width=120 2x" />
                                                </a>
                                        ...
                                        <a class="MagicZoom" id="rg-babolat"
                                           ...
                                           data-options="zoomPosition: #rg-babolat-zoom; zoomWidth:470; zoomHeight:410; transitionEffect: false;expand: off;">
                                            <figure class="mz-figure mz-hover-zoom mz-ready">
                                                <img alt="Magic Zoom Plus - Examples"
                                                     src="<?php echo e($item->getAvatar()); ?>?scale.width=350"
                                                     srcset="<?php echo e($item->getAvatar()); ?>?scale.width=700 2x"
                            ...
                            <div class="col-12 col-lg col_thumb">
                                <div
                                    ...
                                    <div data-grname="not4" data-grpvl="ntt4"
                                         ...
                                         data-src="<?php echo e($item->getAvatar()); ?>"
                                         data-width="570" data-height="570" data-cap="<?php echo e($item->getTitle()); ?>"
                                         style="padding-top:100.0%;">
                                        <img class="op_0 dn"
                                             src="<?php echo e($item->getAvatar()); ?>"
                                             alt="<?php echo e($item->getTitle()); ?>">
                                    </div>
                                    <?php if(count($item->getSlides())): ?>
                                        <?php $__currentLoopData = $item->getSlides(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div data-grname="not4" data-grpvl="ntt4"
                                                 ...
                                                 data-bgset="<?php echo e($photo->getPhoto()); ?>"
                                                 data-ratio="1.0" data-rationav="" data-sizes="auto"
                                                 data-src="<?php echo e($photo->getPhoto()); ?>"
                                                 data-width="570" data-height="570" data-cap="<?php echo e($item->getTitle()); ?>"
                                                 style="padding-top:100.0%;">
                                                <img class="op_0 dn"
                                                     src="<?php echo e($photo->getPhoto()); ?>"
                                                     alt="<?php echo e($item->getTitle()); ?>">
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                ...
                                <?php if($item->discount): ?>
                                    ...
                                    <span class="onsale nt_label">-<?php echo e($item->discount); ?>%</span>
                                </span>
                                <?php endif; ?>
                    ...
                    <div class="col-md-6 col-12 product-infors pr_sticky_su">
                        <div id="shopify-section-pr_summary"
                            ...
                            <h1 class="product_title" style="font-size: 25px"><?php echo e($item->getTitle()); ?></h1>
                            <div class="product_star pr clearfix mb__20">
                                <div class="float-left mr__10">
                                    <?php
                                    for($i=0;$i<=4;$i++):
                                    ?>
                                    <?php if($item->star_count - $i >= 1): ?>
                                        <img src="<?php echo e(url('public/images/star_full.png')); ?>" />
                                    <?php elseif($item->star_count - $i > 0): ?>
                                        <img src="<?php echo e(url('public/images/star_half.png')); ?>" />
                                    <?php else: ?>
                                        <img src="<?php echo e(url('public/images/star_empty.png')); ?>" />
                                    <?php endif; ?>
                                    <?php endfor;?>
                                </div>
                                <div class="float-left">
                                    <a class="text-bold" onclick="jssptab('ttdg')" href="#product_review">(<?php echo e(count($reviews)); ?> đánh giá)</a>
                                </div>
                            </div>
                            <div class="flex wrap fl_between al_center price-review">
                                <p class="price" id="price_ppr">
                                    <?php if($item->price_main != $item->price_pay): ?>
                                        <del class="price_old">
                                            <span class="number_format"><?php echo e($item->price_main); ?></span>
                                            <span class="currency_format">₫</span>
                                        </del>
                                    <?php endif; ?>
                                    <strong>
                                        <span class="number_format" style="font-size: 25px;"><?php echo e($item->price_pay); ?></span>
                                        <span class="currency_format">₫</span>
                                    </strong>
                                ...
                                <div class="info_label ts__03">
                                    <?php if($item->price_main != $item->price_pay): ?>
                                        <div class="info_label_text is_discount">giảm <?php echo e($item->discount); ?>%</div>
                                    <?php endif; ?>
                                    <?php if($item->is_new): ?>
                            ...
                            <?php if(!empty($item->mo_ta_ngan)): ?>
                                <div class="pr_short_des mt__10 mb__10">
                                    <p><?php echo e($item->mo_ta_ngan); ?></p>
                                </div>
                            <?php endif; ?>
                            <?php if($item->push_sale_profile): ?>
                                            ...
                                            <div class="variations_button in_flex column w__100">
                                                <div class="flex wrap">
                                                    ...
                                                    <div class="nt_add_w ts__03 pa order-3">
                                                        <div class="product-love sp-love-<?php echo e($item->id); ?>"
                                                             onclick="jssplove(this, <?php echo e($item->id); ?>)">
                                                            <?php if($item->isLoved()): ?>
                                                    ...
                                                    <button type="button" data-time='6000' data-ani='shake' onclick="jscartdh(<?php echo e($item->id); ?>)"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <div class="text-uppercase text-bold"><?php echo e($apiCore->getSetting('text_sp_combo')); ?></div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td colspan="3" class="clearfix pr">
                                                                <div class="float-left mr__10">
                                                                    <a href="<?php echo e($ite->getHref(true)); ?>">
                                                                        <img class="width_height_80" src="<?php echo e($ite->getAvatar()); ?>" />
                                                                    </a>
                                                                </div>
                                                                <div class="overflow-hidden">
                                                                    <div>
                                                                        <a href="<?php echo e($ite->getHref(true)); ?>">
                                                                            <?php echo e($ite->getTitle()); ?>

                                                                        </a>
                                                                    </div>
                                                                    <div class="grouped-pr-list-item__info">
                                                                        <div class="grouped-pr-list-item__price" >
                                                                            <?php if($ite->price_main != $ite->price_pay): ?>
                                                                                <del class="price_old">
                                                                                    <span class="number_format"><?php echo e($ite->price_main); ?></span>
                                                                                    <span class="currency_format">₫</span>
                                                                                </del>
                                                                            <?php endif; ?>
                                                                            <ins>
                                                                                <span class="number_format text-bold" style="font-size: 20px;"><?php echo e($ite->price_pay); ?></span>
                                                                                <span class="currency_format">₫</span>
                                                                            </ins>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <tr id="cart_combo_<?php echo e($ite->id); ?>">
                                                            ...
                                                            <td class="grouped-pr-list-item__quantity text-center">
                                                                <div class="clearfix">
                                                                    <button type="button" data-time='6000' data-ani='shake' onclick="jscartdhcombo(<?php echo e($ite->id); ?>)"
                                    ...
                                    <?php else: ?>
                                        <form method="post" action="" id="fgr_frm_id" accept-charset="UTF-8" class="variations_form fgr_frm" enctype="multipart/form-data" novalidate="novalidate">
                                            <table cellspacing="0" class="grouped-product-list group_table mb__20">
                                                ...
                                                ?>
                                                <tr id="cart_combo_<?php echo e($ite->id); ?>" class="grouped-pr-list-item item_group_true">
                                                    <td class="grouped-pr-list-item__thumb">
                                                        <a href="<?php echo e($ite->getHref(true)); ?>">
                                                            <img alt="<?php echo e($ite->getTitle()); ?>"
                                                                 src="<?php echo e($ite->getAvatar('normal')); ?>"
                                                                 data-widths="[80, 100, 200, 300, 400]"
                                                                 data-sizes="auto" class=" w__100 lz_op_ef lazyautosizes ls-is-cached lazyloaded"
                                                                 data-srcset="<?php echo e($ite->getAvatar('normal')); ?>"
                                                                 sizes="100px"
                                                                 srcset="<?php echo e($ite->getAvatar('normal')); ?>">
                                                        </a>
                                                    </td>
                                                    <td class="grouped-pr-list-item__info">
                                                        <a href="<?php echo e($ite->getHref(true)); ?>" class="dib mb__10 fwm"><?php echo e($ite->getTitle()); ?></a>
                                                        <div class="grouped-pr-list-item__price" >
                                                            <?php if($ite->price_main != $ite->price_pay): ?>
                                                                <del class="price_old">
                                                                    <span class="number_format"><?php echo e($ite->price_main); ?></span>
                                ...
                                <div class="col-md-12">
                                    <table class="table table-data__info table_product_info">
                                        <?php if($item->getCategory()): ?>
                                            <tr>
                                                <td><?php echo e($apiCore->getSetting('text_sp_nsp')); ?></td>
                                                <td class="cate_cate">
                                                    <a href="<?php echo e($item->getCategory()->getHref()); ?>"
                                                       title="<?php echo e($item->getCategory()->getTitle()); ?>">
                                                        <?php echo e($item->getCategory()->getTitle()); ?>

                                                    </a>
                                                    <?php if($item->getCategoryOthers()): ?>
                                                        <?php $__currentLoopData = $item->getCategoryOthers(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <a href="<?php echo e($ite->getHref()); ?>"
                                                               title="<?php echo e($ite->getTitle()); ?>">
                                                                <?php echo e($ite->getTitle()); ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if($item->getBrand()): ?>
                                            <tr>
                                                <td><?php echo e($apiCore->getSetting('text_sp_th')); ?></td>
                                                <td>
                                                    <a href="<?php echo e($item->getBrand()->getHref()); ?>"
                                                       title="<?php echo e($item->getBrand()->getTitle()); ?>"><?php echo e($item->getBrand()->getTitle()); ?></a>
                                                </td>
                                            </tr>
                                        <?php endif; ?>
                                        <?php if(!empty($item->made_in)): ?>
                                            <tr>
                                                <td><?php echo e($apiCore->getSetting('text_sp_xx')); ?></td>
                                                <td>
                                                    <?php echo e($item->getLabel('made_in')); ?>

                                                </td>
                                            </tr>
                                        <?php endif; ?>
                                        <?php if(!empty($item->kich_thuoc)): ?>
                                            <tr>
                                                <td><?php echo e($apiCore->getSetting('text_sp_kt')); ?></td>
                                                <td>
                                                    <?php echo e($item->kich_thuoc); ?>

                                                </td>
                                            </tr>
                                        <?php endif; ?>
                                        <?php if(!empty($item->the_tich)): ?>
                                            <tr>
                                                <td><?php echo e($apiCore->getSetting('text_sp_tt')); ?></td>
                                                <td>
                                                    <?php echo e($item->the_tich); ?>

                                                </td>
                                            </tr>
                                        <?php endif; ?>
                                        <?php if(!empty($item->can_nang)): ?>
                                            <tr>
                                                <td><?php echo e($apiCore->getSetting('text_sp_cn')); ?></td>
                                                <td>
                                                    <?php echo e($item->can_nang); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mt__20">
                                    <div class="star_wrapper">
                                        <div>
                                            <div class="rating-count-number" id="count_rev_5"><?php echo e($item->countReviewStar(5)); ?></div>
                                        ...
                                        <div>
                                            <div class="rating-count-number" id="count_rev_4"><?php echo e($item->countReviewStar(4)); ?></div>
                                            <div class="rating-group">
                                        ...
                                        <div>
                                            <div class="rating-count-number" id="count_rev_3"><?php echo e($item->countReviewStar(3)); ?></div>
                                            <div class="rating-group">
                                        ...
                                        <div>
                                            <div class="rating-count-number" id="count_rev_2"><?php echo e($item->countReviewStar(2)); ?></div>
                                            <div class="rating-group">
                                        ...
                                        <div>
                                            <div class="rating-count-number" id="count_rev_1"><?php echo e($item->countReviewStar(1)); ?></div>
                                            <div class="rating-group">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="review_wrapper">
                                        <?php if(count($item->getReviews(['limit' => 5]))): ?>
                                            <?php $__currentLoopData = $item->getReviews(['limit' => 5]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php echo $__env->make('modals.front_end.product_review', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </div>

                                    <?php if($item->countReviews() > 5): ?>
                ...
                <div class="col-lg-12 col-12">
                    <div id="shopify-section-collection_page" class="shopify-section tp_se_cdt">
                        ...
                        <div class="products nt_products_holder row fl_center row_pr_1 cdt_des_1 round_cd_false nt_cover ratio_nt position_8 space_30 nt_default">
                            <?php $__currentLoopData = $products_seen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div
            ...
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div id="shopify-section-collection_page" class="shopify-section tp_se_cdt">
                        <div class="nt_svg_loader dn"></div>
                        <div class="products nt_products_holder row fl_center row_pr_1 cdt_des_1 round_cd_false nt_cover ratio_nt position_8 space_30 nt_default">
                            <?php $__currentLoopData = $products_viewed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div
                                    class="col-lg-3 col-md-3 col-12 pr_animated done mt__30 pr_grid_item product nt_pr desgin__1">
                                    <div class="product-inner pr">
                                        <div class="product-image pr oh lazyloaded product-custom" >
            ...
            <div class="mfp-container mfp-s-ready mfp-inline-holder">
                <div class="mfp-content">
                    <div class="popup_video">
                        <?php if($isMobile): ?>
                            <iframe width="400" height="300" src="<?php echo e($item->video_link); ?>" frameborder="0" allowfullscreen></iframe>
                        <?php else: ?>
                            <iframe width="600" height="450" src="<?php echo e($item->video_link); ?>" frameborder="0" allowfullscreen></iframe>
                        <?php endif; ?>
                    </div>
        ...
        <div class="fixed_bot">
            <div class="clearfix">
                ...
                >
                    ...
                    <div class="overflow-hidden">
                        <button type="button" onclick="jscartdh(<?php echo e($item->id); ?>)"
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            <?php if(count($params) && isset($params['t'])): ?>
            jssptab('<?php echo e($params['t']); ?>');
            <?php endif; ?>
        });
    </script>
...
<?php echo $__env->make('templates.front_end.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\geckosotest\resources\views/pages/front_end/products/info.blade.php ENDPATH**/ ?>