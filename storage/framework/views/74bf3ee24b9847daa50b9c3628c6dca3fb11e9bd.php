...
<?php $__env->startSection('content'); ?>
                                        ...
                                        <div id="frm-account">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9" id="frm-name">
                                                    ...
                                                    <div class="txt"><?php echo e($viewer->name); ?></div>

                                                    <div class="input">
                                                        <input id="input-name" value="<?php echo e($viewer->name); ?>" class="form-control text-center" type="text" autocomplete="off" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9" id="frm-email">
                                                    ...
                                                    <div class="txt"><?php echo e($viewer->email); ?></div>

                                                    <div class="input">
                                                        <input id="input-email" value="<?php echo e($viewer->email); ?>" class="form-control text-center" type="email" autocomplete="off" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9" id="frm-phone">
                                                    ...
                                                    <div class="txt"><?php echo e($viewer->phone); ?></div>

                                                    <div class="input">
                                                        <input id="input-phone" value="<?php echo e($viewer->phone); ?>" class="form-control text-center" type="number" autocomplete="off" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9" id="frm-dia_chi_nha">
                                                    ...
                                                    <div class="txt"><?php echo e($viewer->getFullAddress()); ?></div>

                                                    <div class="input" id="frm-address">
                                                        <input id="input-dia_chi_nha" value="<?php echo e($viewer->address); ?>" class="form-control text-center" type="text" autocomplete="off" />
                                                        ...
                                                        <select name="province_id" class="form-control select-css mt__10" onchange="jscartaddressopts(this, 'district')">
                                                            ...
                                                            <?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option <?php if($viewer->province_id == $ite->id): ?> selected="selected" <?php endif; ?> value="<?php echo e($ite->id); ?>"><?php echo e($ite->title); ?></option>
                                                        ...
                                                        <select name="district_id" class="form-control select-css mt__10" onchange="jscartaddressopts(this, 'ward')">
                                                            ...
                                                            <?php if(count($districts)): ?>
                                                                <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option <?php if($viewer->district_id == $ite->id): ?> selected="selected" <?php endif; ?> value="<?php echo e($ite->id); ?>"><?php echo e($ite->title); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            <?php endif; ?>
                                                        </select>
                                                        ...
                                                        <select name="ward_id" class="form-control select-css mt__10">
                                                            ...
                                                            <?php if(count($wards)): ?>
                                                                <?php $__currentLoopData = $wards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option <?php if($viewer->ward_id == $ite->id): ?> selected="selected" <?php endif; ?> value="<?php echo e($ite->id); ?>"><?php echo e($ite->title); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            <?php endif; ?>
                                                        </select>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mb__5">
                                            <select name="person_id" class="form-control">
                                                ...
                                                <?php if(count($persons)): ?>
                                                    <?php $__currentLoopData = $persons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-3 mb__5">
                                            <select name="relationship_id" class="form-control">
                                                ...
                                                <?php if(count($relationships)): ?>
                                                    <?php $__currentLoopData = $relationships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($ite->id); ?>"><?php echo e($ite->getTitle()); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                            </select>
                                        ...
                                        <div class="col-md-2 mb__5">
                                            <select name="month" class="form-control">
                                                ...
                                                <?php for($i=1;$i<=12;$i++): ?>
                                                    <option value="<?php echo e($i); ?>"><?php echo e('Trong Tháng ' . $i); ?></option>
                                                <?php endfor; ?>
                                            </select>
                                        </div>
                                        <div class="col-md-2 mb__5">
                                            <select name="year" class="form-control">
                                                ...
                                                <?php for($i=2021;$i<=date('Y');$i++): ?>
                                                    <option <?php if($i == (int)date('Y')): ?> selected="selected" <?php endif; ?> value="<?php echo e($i); ?>"><?php echo e('Năm ' . $i); ?></option>
                                                <?php endfor; ?>
                                            </select>
                                        </div>
                                        <div class="col-md-2 mb__5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="clearfix">
                                                <select required name="day" class="form-control float-left mr__5 text-center" style="width: 30%;">
                                                    ...
                                                    <?php for($i=1;$i<=31;$i++): ?>
                                                        <option value="<?php echo e($i); ?>"><?php echo e("Ngày " . $i); ?></option>
                                                    <?php endfor; ?>
                                                </select>
                                                ...
                                                <select required name="month" class="form-control float-left mr__5 text-center" style="width: 30%;">
                                                    ...
                                                    <?php for($i=1;$i<=12;$i++): ?>
                                                        <option value="<?php echo e($i); ?>"><?php echo e("Tháng " . $i); ?></option>
                                                    <?php endfor; ?>
                                                </select>
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            jsbindtab1('<?php echo e($params['t']); ?>')
            <?php endif; ?>
...
<?php echo $__env->make('templates.front_end.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\geckosotest\resources\views/pages/front_end/users/account.blade.php ENDPATH**/ ?>