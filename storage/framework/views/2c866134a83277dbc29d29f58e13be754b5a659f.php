...
<?php $__env->startSection('content'); ?>
    ...
    <div>
        <div class="fade-in">
            <div class="row">
                <div class="col-md-12">
                    <div class="btn-menu">
                        <button class="btn btn-primary btn-sm mb-1" onclick="openPage('<?php echo e(url('admin/news/add')); ?>')" >
                    ...
                    <div class="frm-search">
                        <form action="<?php echo e(url('admin/news')); ?>" method="get" >
                            <div class="card">
                                        ...
                                        <td>
                                            <div class="align-right">
                                                <button class="btn btn-info btn-sm mb-1"
                                                        ...
                                                        onclick="openPage('<?php echo e(url('admin/news/add?id=' . $item->id)); ?>')"
                                                >
    ...
    <script type="text/javascript" src="<?php echo e(url('public/js/back_end/news.js')); ?>"></script>
...
<?php echo $__env->make('templates.be.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\geckosotest\resources\views/pages/back_end/news/index.blade.php ENDPATH**/ ?>