    ...
    <div class="frm-popup-main">
        <div class="modal-content">
            ...
            <div class="modal-footer mt-2 text-center">
                <button type="button" class="button button_primary" onclick="gotoPage('<?php echo e(url('gio-hang')); ?>')">Xem Giỏ Hàng</button>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\geckosotest\resources\views/modals/fe.blade.php ENDPATH**/ ?>