                            ...
                            <div class="oh pr nt_img_txt">
                                <div class="js_full_ht4 img_slider_block dek_img_slide">
                                    <div
                                        ...
                                        data-bgset="{{isset($isMobile) ? url('public/uploaded/banner/'.$item->img_banner_mt) : url('public/uploaded/banner/'.$item->img_banner_dt) }}"
                                    ...
                                    <div class="pa_txts caption">
                                        <div class="left_right">
                                            ...
                                            <h3 id="b_1585640512264"
                                                class="slt4_h3 lh__1 mg__0 max_width_500px">{{$title1}}</h3>
