                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            @if (!$user)
                                                <div class="alert alert-info">Mật khẩu mặc định cho nhân viên mới là:
                                                    kh123456
                                                </div>
                                            @else
                                ...
                                <div class="row">
                                    <div class="col-md-3" id="req-name">
                                        <div class="form-group">
                                            ...
                                            <input required value="{{$user ? $user->name : ""}}" name="name" type="text"
                                    ...
                                    <div class="col-md-3" id="req-email">
                                        <div class="form-group">
                                            ...
                                            <input required value="{{$user ? $user->email : ""}}" name="email"
                                                   type="email" autocomplete="off" class="form-control"/>
                                        </div>

                                        <div class="form-group alert alert-danger hidden">Vui lòng nhập email hợp lệ.
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3" id="req-phone">
                                        <div class="form-group">
                                            ...
                                            <input required value="{{$user ? $user->phone : ""}}" name="phone"
                                    ...
                                    <div class="col-md-3" id="req-email">
                                        <div class="form-group">
                                            <label class="frm-label required">* Nhóm khách hàng</label>
                                            <div class="form-group"> <select name="user_category_id">
                                                    @foreach($user_cates as $user_category)

                                                    <option value="{{$user_category->id }}" >{{$user_category->title }}</option>
                                                        @if($user_category->children)
                                                            @foreach($user_category->children as $child)
                                ...
                                <div class="row" id="frm-address">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input value="{{$user ? $user->address : ""}}" name="address" type="text"
                                                   autocomplete="off" class="form-control"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="province_id" class="form-control"
                                                    onchange="jscartaddressopts(this, 'district')">
                                                <option value="">Hãy chọn tỉnh / thành</option>
                                                @foreach($provinces as $ite)
                                                    <option
                                                        @if($user && $user->province_id == $ite->id) selected="selected"
                                                        @endif value="{{$ite->id}}">{{$ite->title}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="district_id" class="form-control"
                                                    onchange="jscartaddressopts(this, 'ward')">
                                                <option value="">Hãy chọn quận / huyện</option>
                                                @if (count($districts))
                                                    @foreach($districts as $ite)
                                                        <option
                                                            @if($user && $user->district_id == $ite->id) selected="selected"
                                                            @endif value="{{$ite->id}}">{{$ite->title}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                            ...
                                            <select name="ward_id" class="form-control">
                                                ...
                                                @if (count($wards))
                                                    @foreach($wards as $ite)
                                                        <option
                                                            @if($user && $user->ward_id == $ite->id) selected="selected"
                                                            @endif value="{{$ite->id}}">{{$ite->title}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-12" id="req-avatar">
                                        <div class="form-group">
                                            <label class="frm-label">Ảnh Đại Diện (Recommended: square 128 x
                                                128)</label>
                                            <div>
                                                <input name="avatar" id="upload-avatar" type="file" accept="image/*"/>
                                                <div class="alert alert-danger hidden mt-3">Vui lòng không upload hình
                                                    lớn hơn <b class="max-size-text"></b>.
                                                </div>
                                            </div>
                                        </div>
