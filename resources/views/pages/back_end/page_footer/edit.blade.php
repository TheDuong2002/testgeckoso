...
@section('content')
    ...
    <div>
        <div class="fade-in">
            <form action="{{ url('/admin/page-footer/saveUpate', $data->id) }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-12" id="req-title">
                                        <div class="form-group">
                                            ...
                                            <input required value="{{ $data ? $data->tile : "" }}" name="tile" type="text" autocomplete="off"
                                                   class="form-control" />
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12" id="req-title">
                                        <div class="form-group">
                                            ...
                                            <input required value="{{ $data ? $data->href : "" }}" name="href" type="text" autocomplete="off"
                                                   class="form-control" />
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12" id="req-mota">
                                        <div class="form-group">
                                            ...
                                            <textarea id="editor" name="body" class="c-tinymce" rows="5">{{ $data ? $data->body : "" }}</textarea>
                                        </div>
